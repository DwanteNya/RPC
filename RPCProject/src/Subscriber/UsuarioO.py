...
class TicTacToe:
    def __init__(self, root):
        ...
        self.label_player = tk.Label(root, text=f"Jogador O", font=("Helvetica", 16))
    ...
    def Esperando_Jogada(self):
        ...
        while True:
            method_frame, header_frame, body = channel.basic_get(queue='Tabuleiro_XO', auto_ack=True)
            if method_frame:
